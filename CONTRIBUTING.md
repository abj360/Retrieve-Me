# Contributing to retrieval-core

Thanks for helping build retrieval-core. This document is the whole workflow:
...
```bash
git clone git@github.com:abj360/retrieval-core.git
cd retrieval-core
...
- **Every feature lands on a feature branch**, never directly on `main`.
  ...
  `abj360/retrieval-core`. Never push branches from someone else's account.
